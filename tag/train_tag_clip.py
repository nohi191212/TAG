...
from tag.lib.dataset import load_aokvqa, AokvqaEmbeddingsDataModule, AokvqaFineTuneDataModule
...
def main():
    ...
    model = ClipBartTAGFinetune(
        ...
        args.epochs,
        steps_per_epoch,
        num_clip_finetune_layers=args.num_clip_finetune_layers,
        bsz=args.batch_size,
    )
    model.float() # else nan in training
